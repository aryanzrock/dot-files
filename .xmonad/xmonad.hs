...
myFont :: String
myFont = "xft:Lato Mono:regular:size=9:antialias=true:hinting=true"
...
myBrowser :: String
myBrowser = "Google-chrome"  -- Sets qutebrowser as browser
...
myStartupHook = do
    ...
    spawnOnce "trayer --edge top --align right --widthtype request --padding 6 --SetDockType true --SetPartialStrut true --expand true --monitor 1 --transparent true --alpha 70 --tint 0x1c1c1c  --height 20 &"
    --spawnOnce "/usr/bin/emacs --daemon &" -- emacs daemon for the emacsclient
    -- spawnOnce "kak -d -s mysession &"  -- kakoune daemon for better performance
    -- spawnOnce "urxvtd -q -o -f &"      -- urxvt daemon for better performance

    -- spawnOnce "xargs xwallpaper --stretch < ~/.xwallpapers"  -- set last saved with xwallpaper
    -- spawnOnce "/bin/ls ~/wallpapers | shuf -n 1 | xargs xwallpaper --stretch"  -- set random xwallpaper
    -- spawnOnce "~/.fehbg &"  -- set last saved feh wallpaper
    spawnOnce "feh --randomize --bg-fill ~/Pictures/Wallpapers/wallpapers/*"  -- feh set random wallpaper
...
myKeys =
    ...
    -- Then in sxiv, type 'C-x w' to set the wallpaper that you choose.
        --, ("M-<F1>", spawn "sxiv -r -q -t -o ~/Pictures/Wallpapers/wallpapers/*")
        --, ("M-<F2>", spawn "/bin/ls ~/wallpapers | shuf -n 1 | xargs xwallpaper --stretch")
        , ("M-<F2>", spawn "feh --randomize --bg-fill ~/Pictures/Wallpapers/wallpapers/*")
